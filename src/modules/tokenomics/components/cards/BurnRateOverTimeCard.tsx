...
import { CardHeader, CardTitle, CardContent } from '@/common/components/ui/Card';
...
const mockChartData = {
  '7d': Array.from({ length: 7 }, (_, i) => ({ date: `2024-09-${String(i + 1).padStart(2, '0')}`, value: Math.random() * 100 })),
  '30d': Array.from({ length: 30 }, (_, i) => ({ date: `2024-08-${String(i + 1).padStart(2, '0')}`, value: Math.random() * 100 })),
  '90d': Array.from({ length: 90 }, (_, i) => ({ date: `2024-07-${String(i + 1).padStart(2, '0')}`, value: Math.random() * 100 })),
};
